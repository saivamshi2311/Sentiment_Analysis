...
train_vectors = [featurize_5_text(text) for text in train_texts]
train_vectors = normalize(train_vectors)

dev_vectors = [featurize_5_text(text) for text in dev_texts]
...
test_vectors = [featurize_5_text(text) for text in test_data]
